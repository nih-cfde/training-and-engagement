...
- Make a change and save it to a new branch named after the specific workshop (e.g. jan-workshop, feb-workshop). Do NOT create a PR yet.
- Go to HackMd. Ckick "New note" then "Pull from GitHub". Select the GitHub repo and the lesson file. Accept all the changes. 
