...
`MacOS <#global-install-of-jekyll-for-macos-using-command-line>`__ -
`Windows OS <#install-and-website-build-for-windows-os>`__
...
2.6.3. If we're running a previous macOS system, we'll have to `install
a newer version of
Ruby <https://jekyllrb.com/docs/installation/macos/#brew>`__.
...
first two digits of our Ruby version. E.g. my ``ruby -v`` was 2.6.3, so
I replaced X.X.0 with 2.6.0.
