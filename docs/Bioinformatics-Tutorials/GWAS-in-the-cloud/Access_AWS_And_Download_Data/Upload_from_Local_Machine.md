...
Access AWS instance, upload data from local machine & install helper functions
==============================================================================

!!! Important
    If you already downloaded data by following instructions in the [direct downloads](Direct_Download.md) page, you should skip this step and proceed to [Install PLINK](../../plink_install.md)
