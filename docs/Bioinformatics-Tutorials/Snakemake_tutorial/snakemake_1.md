...
- Part 2: [Decorating the Snakefile](./snakemake_3.md#Decorating the Snakefile)

- Part 3: [Running through the entire Snakemake workflow](./snakemake_3.md#Decorating the Snakefile)
