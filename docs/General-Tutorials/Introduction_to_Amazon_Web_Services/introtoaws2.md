...
=== "Windows"
	You may choose to follow the walkthrough tutorial video first or proceed to follow the instructions provided on the webpage. This tutorial includes directions for connecting via __Windows__.
...
=== "Mac Os"
	You may choose to follow the walkthrough tutorial video first or proceed to follow the instructions provided on the webpage. This tutorial includes directions for connecting via __MAC OS__.
