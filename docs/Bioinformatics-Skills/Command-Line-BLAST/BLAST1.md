...
--- | --- | ---
30 mins | [Install BLAST](../Command-Line-BLAST/BLAST3.md) | Set up local BLAST installation on your computer
15 mins | [How to Run BLAST+](../Command-Line-BLAST/BLAST4.md) | Run BLAST analysis with AWS
