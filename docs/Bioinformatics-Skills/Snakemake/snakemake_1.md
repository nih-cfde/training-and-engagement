...
- Click on the "Terminal" button to launch it:
    ...
    ![binder terminal button](../../images/snakemake_binder_terminal.png "binder terminal button")
...
- To download files, right-click the file you want to save, and select "Download":
    ...
    ![binder download button](../../images/snakemake_binder_download.png "binder download button")

- To close the binder, go to "File" and click "Shut Down":

    ![shut down binder button](../../images/snakemake_binder_close.png "shut down binder button")
