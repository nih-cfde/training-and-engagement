...
The goal of this tutorial is to learn how to run and switch between multiple screen sessions. Check out the [screen cheat sheet](../../General-Tools/Cheat-Sheets/screen_cheatsheet.md) for commonly used commands.
...
Don't forget to check out our [screen cheat sheet](../../General-Tools/Cheat-Sheets/screen_cheatsheet.md) if you need a quick reference to screen commands.
